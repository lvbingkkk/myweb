...
<div   style="position:fixed;left: 0px;right: 0px;top:0px;bottom: 0px; z-index:-1; background-color: #000;  /*overflow: hidden; */ /*background-repeat: no-repeat;*/">
...
void main(){
	...
	dist = getWaveGlow(pos, radius,intensity, 4.0, 0.03, 2.0, 0.0);
	col += dist * vec3(0.6,1.0,1.5);
 	dist = getWaveGlow(pos, radius, intensity, 1.0, 0.02, 2.0, 2.0);
	col += dist * vec3(0.8,0.2,1.2);
	...
	col += dist * (vec3(0.1) + 0.5 + 0.5*cos(time+vec3(0,2,9)));
